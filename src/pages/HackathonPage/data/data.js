export const popularTags = ["Productivity", "Blockchain", "Machine Learning/AI", "Social Good", "COVID-19", "Beginner Friendly"];
export const tags = ["Productivity", "Web", "Blockchain", "Machine Learning/AI", "Social Good","Mobile", "COVID-19", "Beginner Friendly", "Communication", "Education", "Gaming", "IoT", "Health", "FinTech", "Music", "Quantum"];
export const hosts = ["Samsung", "Tesla", "Google", "Apple", "Amazon", "Sony", "Facebook", "Meta"];
